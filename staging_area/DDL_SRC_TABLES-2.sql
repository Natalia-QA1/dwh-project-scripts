--SRC table for first dataset
CREATE TABLE IF NOT EXISTS sa_source_1.ext_table_1 (
...
--to implement incremental loading
ALTER TABLE sa_source_1.ext_table_1 
ADD COLUMN IS_PROCESSED varchar(1);
